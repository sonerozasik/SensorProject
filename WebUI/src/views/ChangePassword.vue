                    ...
                    <div class="col-lg-12 login-form">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" i v-model="oldPasswordText">
                            </div>
                            <div class="form-group">
                                <label class="form-control-label">NEW PASSWORD</label>
                                <input type="password" class="form-control" i v-model="newPasswordText">
                            </div>
                             <div class="form-group">
                                <label class="form-control-label">CONFIRM NEW PASSWORD</label>
                                <input type="password" class="form-control" i v-model="confirmNewPasswordText">
                            </div>

                            <div class="col-lg-12 loginbttm">
                                <div class="col-lg-6 login-btm login-button">
                                    <div @click="changePassword()" type="submit" class="btn btn-outline-primary">SUBMIT</div>
                                </div>
                            </div>
                        </form>
                    </div>
